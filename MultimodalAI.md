...
## 1. 개요 (Overview)
Multimodal AI(멀티모달 AI)는 텍스트, 이미지, 오디오, 비디오 등 서로 다른 형태(Modality)의 데이터를 함께 처리하고 이해하는 [AI](./ArtificialIntelligence.md) 기술입니다. 인간이 시각, 청각 등 다양한 감각을 통해 세상을 이해하는 것과 같습니다.
...
### 3.3. GPT-4V / Gemini
최신 [LLM](./GPT.md)들은 텍스트뿐만 아니라 이미지를 입력으로 받아 분석하고 추론하는 멀티모달 능력을 갖추고 있습니다.
